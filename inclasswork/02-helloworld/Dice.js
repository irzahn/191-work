// Constructor Method
function Dice(init_x, init_y, size, color){
    // Parameters
    this.loc = {
        x: init_x,
        y: init_y
...
Dice.prototype.frame = function(objArr, myIdx){
    this.bounce();
...
Dice.prototype.display = function () {
    ...
    fill('#fff');
    //translate(50,100);
    ellipse(-this.eye.x, this.eye.y, 20, 20);
    //fill('#000');
...
Dice.prototype.bounce = function () {
    // move horizontally
...
Dice.prototype.checkCollisions = function (objArr, myIdx) {
